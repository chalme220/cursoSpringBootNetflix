...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		...
		//sustituimos el localhost.. por el nombre del servicio (application.properties de Productos) declarada en SpringbootServicioItemApplication
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://servicio-productos/listar", Producto[].class));
		//propio de Java 8  expresiones lambdas
	...
	public void delete(Long id) {
		Map<String, String> pathVariables = new HashMap<String, String>();
		pathVariables.put("id", id.toString());
		//llamamos a la funcion delete en vez de la exchange
